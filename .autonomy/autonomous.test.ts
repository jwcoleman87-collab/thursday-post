...
function items(title='Veterinary horse racing community report'):SourceItem[]{
 ...
 return [{...common,id:'official'}, {...common,id:'email',type:'email',url:'mailto:fixture@example.invalid',content:'An unverified eyewitness tip.'}, {...common,id:'media',type:'media',url:'https://racing-authority.test/media'}];
}
