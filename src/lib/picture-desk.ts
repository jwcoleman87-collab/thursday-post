...
const RACING_WORDS = /\b(horse|horses|racehorse|racing|race|races|raced|jockey|trainer|racecourse|race ?course|turf|stakes|cup|thoroughbred|mounting yard|gelding|mare|colt|filly|stallion|stud|derby|oaks|plate|handicap|meeting|carnival)\b/i;
...
export function commonsCandidates(response: unknown, term: PictureTerm, addedAt: string): LicensedImage[] {
  ...
  for (const page of pages) {
    ...
    const shows = (description || title).slice(0, 280).replace(/\.$/, '');
